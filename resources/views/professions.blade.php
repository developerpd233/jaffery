@extends('layouts.app')
@section('meta_title', 'Profession')
@section('meta_description', 'Profession')
@section('page_title', 'Professions')
...
<section class="photo-sec">
    <div class="container-fluid">
        ...
        <div class="hero-search">
            <input type="name" id="searchbar" name="" placeholder="Search by Profession">
    ...
    function search() {
        ...
        if (input.length > 2) {
            ...
            $.ajax({
                type:"GET",
                url: '{{ url("/search") }}',
                data: {search: input,type:'profession'},
