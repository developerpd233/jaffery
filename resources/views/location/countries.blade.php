@extends('layouts.app')
@section('meta_title', 'Country')
@section('meta_description', 'Country')
...
<section class="photo-sec">
	<div class="container-fluid">
		...
		<div class="hero-search">
        	<input type="name" id="searchbar" name="" placeholder="Search by Country">
			...
			$.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        ...
                        {
                            var url = '{{ url("country/") }}'+'/'+d.name;
                            $('#list').append(`<a href="${url}" class="search">${d.flag_image}${d.name}</a>`);       
                        });
                    } 
                    else {
