@extends('layouts.app')
@section('meta_title', 'City')
@section('meta_description', 'City')
...
<section class="photo-sec">
    <div class="container-fluid">
        ...
        <div class="hero-search">
            <input type="name" id="searchbar" name="" placeholder="Search by City">
